...
真实切片支持哪些 spot-level expression programmes、spatial domains、graph edges 与 labelled neighbourhoods，何时才有理由进行 cell-composition deconvolution？每个结论都必须声明它描述的是实测 spot、估计 mixture，还是 cell-resolved hypothesis。
